    ...
    contractAddress = '0x758873b4f5dcc43a2f6e03b1d48e357441812dd7'; //오토십 구매 테스팅
    ...
    var keystore = JSON.parse('{"version":3,"id":"f448804b-2940-4d55-b0fa-381a223b4655","address":"ca836e83ceeb0e712da45840a62757094e966847","crypto":{"ciphertext":"b08b53872b38e816c7f44807f9bd955d3be5f5a4778b45af3beee0021ae6c618","cipherparams":{"iv":"8b6f8e708b594f9a18793863f78f0d15"},"cipher":"aes-128-ctr","kdf":"scrypt","kdfparams":{"dklen":32,"salt":"d907408fd50dfb5e34f532372d53eb323e9199b7ab7bf934f8566d1f743e3059","n":8192,"r":8,"p":1},"mac":"41bb73b6c1e446dd3afa591a7789666d2cee8185093e2f0143ebfb7a39031242"}}');
    ...
    function buyLottery(vnonce) {
        var _buyer = "0xca836e83ceeb0e712da45840a62757094e966847";
        var _donationid = 1;
        ...
        console.log(enabi);
        web3.eth.sendTransaction({from:web3.eth.defaultAccount ,to:contractAddress, value:0, gas:5900000, gasPrice:1000000000, data:enabi, nonce:vnonce})
        ...
        function buy20Lottery() {
          ...
          var enabi = contract.methods.buyLottery(_buyer,_donationid,_lotNumber).encodeABI();
          console.log(enabi);
          web3.eth.sendTransaction({from:web3.eth.defaultAccount ,to:contractAddress, value:0, gas:5900000, gasPrice:1000000000, data:enabi})
          .on('transactionHash', function(hash){
            console.log(hash);
            //res.send({status: 'success', msg: ''});
          })
...
async function buyAutoLotterynonce() {
        console.log("Active")
        buyAutoLottery();
        await sleep(300000);
}
